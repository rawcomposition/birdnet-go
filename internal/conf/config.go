...
type DashboardElement struct {
	ID      string                `json:"id,omitempty"`      // unique identifier (e.g., "daily-summary-0"); generated by migration if empty
	...
	Width   string                `json:"width,omitempty"`   // "full" or "half"; defaults to "full" if empty
